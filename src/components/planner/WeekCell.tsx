...
export function WeekCell({ 
  hours, capacity, status, percentage, isCurrentWeek, hasAbsence, absenceHours = 0, baseCapacity, onClick 
}: WeekCellProps) {
  ...
  const statusClasses = {
    ...
    healthy: 'bg-green-50/50 border-green-200 hover:bg-green-100/50',
    warning: 'bg-yellow-50/50 border-yellow-200 hover:bg-yellow-100/50',
    overload: 'bg-red-50/50 border-red-200 hover:bg-red-100/50',
    sweetSpot: 'bg-indigo-50 border-indigo-300 shadow-sm ring-1 ring-indigo-200'
  };
  ...
  const textClasses = {
    ...
    sweetSpot: 'text-indigo-700'
  };

  const barColor = {
      empty: 'bg-slate-200', healthy: 'bg-green-500', warning: 'bg-yellow-500', overload: 'bg-red-500', sweetSpot: 'bg-indigo-500'
  };
