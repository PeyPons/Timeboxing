...
import {
  ...
  Rocket, ShieldCheck, GitBranch, AlertTriangle, Download,
...
import { AgencyIntegrationsTab } from '@/components/agencies/AgencyIntegrationsTab';
import {
        ...
        <div className="min-w-0 space-y-6 rounded-2xl border border-slate-200 bg-white/80 shadow-sm p-3 sm:p-4 lg:p-6">
          ...
          <TabsContent value="integrations" className="mt-0 space-y-6">
            <AgencyIntegrationsTab
              fetchAccountsEnabled={activeTab === 'integrations'}
